...
export const JOBS_DATA = [
  {
    ...
    name: '心理学・カウンセラー系',
    trait: [
      '〇〇さんは、相手の話をじっくり聞くことができる人。自分の意見よりも、相手の気持ちを大事にできるタイプです。',
    ],
    reason: [
      '日本の心理カウンセリング市場は、約350億円規模。AIが何でも答えてくれる時代でも、「人に話を聞いてほしい」というニーズはなくなりません。',
    ],
...
<img border="0" width="1" height="1" src="https://www19.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: '占い師・スピリチュアル系',
    trait: [
      '〇〇さんは、相手の表情や言葉のちょっとした変化にも気づける人。悩んでいる人に寄り添い、背中を押すことができるタイプです。',
    ],
    reason: [
      '占い市場は、年間997億円規模まで成長中。AIに聞けば何でも分かる時代だからこそ、人に相談したい人は増えています。',
    ],
...
<img border="0" width="1" height="1" src="https://www16.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: '食・料理・栄養系',
    trait: [
      '〇〇さんは、家族や自分の食生活に、日頃から気を配れる人。自分のことはもちろん、周りの人の食事や体調まで気にかけてしまうタイプです。',
    ],
    reason: [
      'これから訪れる高齢化社会では、栄養や食事の管理がますます重要になります。生活習慣病が若い世代にも増える中、正しい食の知識を持つ人は仕事でも求められます。',
    ],
...
<img border="0" width="1" height="1" src="https://www14.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: '手芸・ハンドメイド系',
    trait: [
      '〇〇さんは、黙々とモノを作るのが好きな職人タイプ。一度ハマったら、本格的に極めたいという気持ちが強い人です。',
    ],
    reason: [
      '資格があれば、作品販売やワークショップの開催も、自信を持って始められます。将来は、教室を開いて講師として活動する道も選べます。',
    ],
...
<img border="0" width="1" height="1" src="https://www12.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    reason: [
      '意外かもしれませんが、ペットトリマーは美容師と違って国家資格が不要。ペットを飼う人は年々増え続けていて、動物関連の仕事はこれからも需要が高まり続けます。',
    ],
...
<img border="0" width="1" height="1" src="https://www15.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: '片付け・整理収納系',
    trait: [
      '〇〇さんは、片付けや仕組みづくりを考えるのが好きな人。それだけでなく、相手の暮らしや悩みに、自然と耳を傾けられるタイプです。',
    ],
    reason: [
      '実際に自宅を訪問し、その場の空間を見ながらアドバイスできるのは、AIにはない強みです。独立すれば、店舗を持たずに始められる身軽さも魅力です。',
    ],
...
<img border="0" width="1" height="1" src="https://www10.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: '植物・花・園芸系',
    trait: [
      '〇〇さんは、色の組み合わせやバランスを考えるのが好きな人。手先を使った細かい作業も、丁寧にこなせるタイプです。',
    ],
    reason: [
      'どんなに時代が変わっても、人が花や緑を求める気持ちはなくなりません。資格を取れば、独立してフラワーデザイナーとして活動する道も選べます。',
    ],
...
<img border="0" width="1" height="1" src="https://www19.a8.net/0.gif?a8mat=4B81T1+ARM1OQ+4N6C+BW8O2" alt="">`,
  },
  {
    ...
    name: 'デザイン・デザイナー系',
    trait: [
      '〇〇さんは、相手の要望を聞き出すのが得意で、細部までこだわり抜ける人。新しい情報を、素直に学び続けられるタイプです。',
    ],
    reason: [
      '学び続ける姿勢や、周りと協力し合える協調性が、そのまま強みとして活きる仕事です。実際にその場に足を運び、素材や照明の当たり方まで見て細部を調整する仕事は、AIにはできません。',
    ],
